...
@Directive({
  selector: '[appAggregationL]'
})
export class AggregationLDirective {
          ...
          move(event) {
            ...
            if (resizeRight) {
              target.setAttributeNS(null, "d",
                ...
                + " L " + (arrowFourthX + changeX) + " " + arrowFourthY
                + " M " + (arrowFifthX + changeX) + " " + arrowFifthY
                + " L " + (arrowSixthX + changeX) + " " + arrowSixthY
                + " L " + (arrowSeventhX + changeX) + " " + arrowSeventhY
                + " L " + (arrowEigthX + changeX) + " " + arrowEigthY);
            }
          }
        },
        modifiers: [
