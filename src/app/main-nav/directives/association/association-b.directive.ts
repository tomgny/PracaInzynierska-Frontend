...
@Directive({
  selector: '[appAssociationB]'
})
export class AssociationBDirective {
      ...
      .resizable({
        ...
        listeners: {
          move(event) {
            ...
            if (event.client.y + (parentScrollTop) - (dataY + parseInt(target.parentElement.parentElement.parentElement.offsetTop) || 0) + 50 > arrowSixthY &&
              (event.client.y + (parentScrollTop) - (dataY + parseInt(target.parentElement.parentElement.parentElement.offsetTop) || 0)) - 50 < arrowSixthY) {
              resizeTop = true;
              //console.log("top!");
            }
