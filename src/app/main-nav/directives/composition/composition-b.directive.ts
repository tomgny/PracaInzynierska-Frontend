...
@Directive({
  selector: '[appCompositionB]'
})
export class CompositionBDirective {
      ...
      .resizable({
        ...
        listeners: {
          move(event) {
            ...
            if (event.client.y + parentScrollTop - (dataY + parseInt(target.parentElement.parentElement.parentElement.offsetTop) || 0) + 50 > arrowFourthY && (event.client.y + parentScrollTop - (dataY + parentScrollTop + parseInt(target.parentElement.parentElement.parentElement.offsetTop) || 0)) - 50 < arrowFourthY) {
              resizeTop = true;
              console.log("top!");
            }
