...
@Directive({
  selector: '[appImplemetsLt]'
})
export class ImplemetsLtDirective {
      ...
      .resizable({
        ...
        listeners: {
          move(event) {
            ...
            if ((event.client.x + parentScrollLeft - dataX) + 50 > firstOutsideArrowX && (event.client.x + parentScrollLeft - dataX) - 50 < firstOutsideArrowX) {
              resizeRight = true;
              console.log("RIGHT!");
            ...
            if (resizeRight) {
              target.setAttributeNS(null, "d",
                ...
                + " L " + (fifthSquareRTx + changeX) + " " + (fifthSquareRTy + changeY)
                + " L " + (fifthSquareRBx + changeX) + " " + (fifthSquareRBy + changeY)
                + " M " + (firstInsideArrowX + changeX) + " " + (firstInsideArrowY + changeY)
                + " L " + (secondInsideArrowX + changeX) + " " + (secondInsideArrowY + changeY)
                + " L " + (thirdInsideArrowX + changeX) + " " + (thirdInsideArrowY + changeY)
                + " M " + (firstOutsideArrowX + changeX) + " " + (firstOutsideArrowY + changeY)
                + " L " + (secondOutsideArrowX + changeX) + " " + (secondOutsideArrowY + changeY)
                + " L " + (thirdOutsideArrowX + changeX) + " " + (thirdOutsideArrowY + changeY)
              );
            }
            if (resizeLeft) {
              target.setAttributeNS(null, "d",
                "M " + (firstSquareLTx + changeX) + " " + (firstSquareLTy + changeY)
                + " L " + (firstSquareLBx + changeX) + " " + (firstSquareLBy + changeY)
                + " L " + firstSquareRTx + " " + firstSquareRTy
                + " L " + firstSquareRBx + " " + firstSquareRBy
                + " M " + secondSquareLTx + " " + secondSquareLTy
                + " L " + secondSquareLBx + " " + secondSquareLBy
