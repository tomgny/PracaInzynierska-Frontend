...
@Directive({
  selector: '[appImplemetsRb]'
})
export class ImplemetsRbDirective {
          ...
          move(event) {
            ...
            if (resizeRight) {
              target.setAttributeNS(null, "d",
                ...
                + " L " + (secondSquareRTx + changeX) + " " + (secondSquareRTy + changeY)
                + " L " + (secondSquareRBx + changeX) + " " + (secondSquareRBy + changeY)
