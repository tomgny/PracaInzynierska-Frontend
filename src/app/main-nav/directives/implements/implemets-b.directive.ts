...
@Directive({
  selector: '[appImplemetsB]'
})
export class ImplemetsBDirective {
      ...
      .resizable({
        ...
        listeners: {
          move(event) {
            ...
            if (event.client.y + parentScrollTop - (dataY + parseInt(target.parentElement.parentElement.parentElement.offsetTop) || 0) + 50 > firstSquareLTy && (event.client.y + parentScrollTop - (dataY + parseInt(target.parentElement.parentElement.parentElement.offsetTop) || 0)) - 50 < firstSquareLTy) {
              resizeTop = true;
              console.log("btm!");

            }
            if (event.client.y + parentScrollTop - (dataY + parseInt(target.parentElement.parentElement.parentElement.offsetTop) || 0) + 50 > thirdOutsideArrowY && (event.client.y + parentScrollTop - (dataY + parseInt(target.parentElement.parentElement.parentElement.offsetTop) || 0)) - 50 < thirdOutsideArrowY) {
              resizeBottom = true;
              console.log("top!");
            }
            ...
            if (resizeBottom) {
              target.setAttributeNS(null, "d",
                ...
                + " L " + fifthSquareRTx + " " + (fifthSquareRTy + changeY)
                + " L " + fifthSquareRBx + " " + (fifthSquareRBy + changeY)
                + " M " + firstInsideArrowX + " " + (firstInsideArrowY + changeY)
                + " L " + secondInsideArrowX + " " + (secondInsideArrowY + changeY)
                + " L " + thirdInsideArrowX + " " + (thirdInsideArrowY + changeY)
                + " M " + firstOutsideArrowX + " " + (firstOutsideArrowY + changeY)
                + " L " + secondOutsideArrowX + " " + (secondOutsideArrowY + changeY)
                + " L " + thirdOutsideArrowX + " " + (thirdOutsideArrowY + changeY)
              );
            }
            if (resizeTop) {
              target.setAttributeNS(null, "d",
                "M " + firstSquareLTx + " " + (firstSquareLTy + changeY)
                + " L " + firstSquareLBx + " " + (firstSquareLBy + changeY)
                + " L " + firstSquareRTx + " " + firstSquareRTy
                + " L " + firstSquareRBx + " " + firstSquareRBy
                + " M " + secondSquareLTx + " " + secondSquareLTy
                + " L " + secondSquareLBx + " " + secondSquareLBy
