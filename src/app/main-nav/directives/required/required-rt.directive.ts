...
@Directive({
  selector: '[appRequiredRt]'
})
export class RequiredRtDirective {
      ...
      .resizable({
        ...
        listeners: {
          move(event) {
            ...
            if ((event.client.x + parentScrollLeft - dataX) + 50 > arrowFifthX && (event.client.x + parentScrollLeft - dataX) - 50 < arrowFifthX) {
              resizeRight = true;
              //console.log("RIGHT!");
